...
import { LightBulbIcon } from "../elements/Icons";
    ...
    <div className="hidden lg:flex flex-row flex-wrap gap-8 relative w-[700px] h-[500px]">
      ...
      <Card className="absolute w-[340px] -top-[15px] drop-shadow-xl shadow-black/10 dark:shadow-white/10">
        <CardHeader className="flex flex-row items-center gap-4 pb-2">
          <Avatar>
            <AvatarImage alt="" src="https://avatars.githubusercontent.com/u/106727010?s=400&u=f148fdd36c8fd3d0f35d608cb80cd5bc330d706f&v=4" />
            <AvatarFallback>SH</AvatarFallback>
          </Avatar>

          <div className="flex flex-col">
            <CardTitle className="text-lg">Galih Agus Saputra</CardTitle>
            <CardDescription>@galih17421010</CardDescription>
          </div>
        </CardHeader>
      ...
      <Card className="absolute right-[20px] top-4 w-80 flex flex-col justify-center items-center drop-shadow-xl shadow-black/10 dark:shadow-white/10">
        <CardHeader className="mt-8 flex justify-center items-center pb-2">
          ...
          <CardTitle className="text-center">Galih Agus Saputra</CardTitle>
          <CardDescription className="font-normal text-primary">Website Developer</CardDescription>
        </CardHeader>
