...
const articles: ArticleProps[] = [
  {
    image: "https://avatars.githubusercontent.com/u/106727010?v=4",
    name: "John Doe React",
    userName: "@john_Doe",
...
export const Articles = () => {
  return (
    <section id="articles" className="container py-24 sm:py-10">
      ...
      <div className="grid md:grid-cols-2 lg:grid-cols-4 sm:block columns-2  lg:columns-3 lg:gap-6 mx-auto space-y-4 lg:space-y-6">
        {articles.map(({ image, name, userName, comment }: ArticleProps) => (
